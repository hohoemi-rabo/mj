...
// adapter ⇄ gameStore の配線フック（docs/14）。
// store / adapterRef はモジュール singleton なので Provider は不要。クライアント境界の最上位
// （GameBoard / PracticeStartButton）で呼び、「未接続なら LocalAdapter を生成して connect」する。
//
